...
<head>
    ...
    <link rel="stylesheet" href="./public/css/admin-midwife.css">
</head>
<body id="body-pd">
    ...
    <div class="height-100 main-content">
        <div class="container mt-5 midwife-form">
            ...
            <?php foreach ($midwife_data as $midwife): ?>
                <form action="./app/controllers/admin-midwife/update_midwife.php" method="post" enctype="multipart/form-data" class="row g-4">
                    ...
                    <div class="col-12 d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary">Update Midwife Information</button>
                    </div>
                </form>
                <hr class="my-4">
            <?php endforeach; ?>
